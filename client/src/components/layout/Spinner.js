...
export default () => (
  <Fragment>
    <svg id="svg-spinner" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
      <circle cx="24" cy="4" r="4" fill="#F90"/>
      <circle cx="12.19" cy="7.86" r="3.7" fill="#F90"/>
      <circle cx="5.02" cy="17.68" r="3.4" fill="#F90"/>
      <circle cx="5.02" cy="30.32" r="3.1" fill="#F90"/>
      <circle cx="12.19" cy="40.14" r="2.8" fill="#F90"/>
      <circle cx="24" cy="44" r="2.5" fill="#F90"/>
